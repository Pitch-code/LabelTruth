package com.labellens.app.ui.about
...
import com.labellens.app.BuildConfig
import com.labellens.app.R
import com.labellens.app.ui.history.TopBar
...
fun AboutScreen(onBack: () -> Unit) {
    Column(
        ...
        Column(
            ...
            Block(
                title = "Your privacy",
                body = "LabelLens has no account and no analytics. Camera frames are " +
